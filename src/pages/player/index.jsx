    ...
    const getItemDisplay = useCallback(
        (loadoutItem, imageOptions = {}, itemSource) => {
            ...
            if (loadoutItem.upd?.Repairable) {
                countLabel = `${Math.round(loadoutItem.upd.Repairable.Durability)}/${Math.round(loadoutItem.upd.Repairable.MaxDurability)}`;
            }
                            ...
                            {playerData.aid !== 0 && !playerData.saved && (
                                <span>
                                    ...
                                    {playerBanned === true && (
                                        <Tooltip
                                            title={t(
                                                "Ban detection may not always be accurate, especially if the account was recently renamed.",
                                            )}
                                            arrow
                                        >
                    ...
                    <>
                        ...
                        <div className="inventory">
                            ...
                            <div className="grid-container side">
                                ...
                                <div className="pockets_and_special_slots slot-label">
