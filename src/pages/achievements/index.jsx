        ...
        () => [
            ...
            },
            {
                ...
                Cell: (props) => {
                    return (
                        <Icon
                            path={props.value ? mdiCheckboxMarked : mdiCheckboxBlank}
                            size={1.5}
            ...
            },
            {
                ...
                Cell: (props) => <div className="center-content">{props.value}%</div>,
                sortType: (rowA, rowB) =>
    ...
    return [
        <SEO
            ...
            description={t(
                ...
                "This page includes information on the achievements that can be earned.",
            )}
            key="seo-wrapper"
        />,
