...
function Crafts() {
    ...
    const [averagePrices, setAveragePrices] = useStateWithLocalStorage("averageCraftingPrices", false);
    ...
    const stations = useMemo(() => {
        return hideout
            .filter((s) => s.crafts?.length && s.normalizedName !== "bitcoin-farm")
            .sort((a, b) => {
            ...
            <div className="crafts-headline-wrapper" key="crafts-filters">
                ...
                <Filter>
                    ...
                    <ToggleFilter
                        ...
                        tooltipContent={<>{t("Use average prices from the past 24 hours for profit calculations")}</>}
                    />
                    <ButtonGroupFilter>
                        {stations.map((station) => {
                            return (
                                <ButtonGroupFilterButton
                                    ...
                                    content={<img alt={station.name} loading="lazy" src={station.imageLink} />}
                                    onClick={() => {
