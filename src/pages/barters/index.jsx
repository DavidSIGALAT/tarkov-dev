...
function Barters() {
    ...
    const [showAll, setShowAll] = useStateWithLocalStorage("showAllBarters", false);
    ...
    return [
        <SEO
            ...
            description={t(
                "barters-page-description",
                "This page includes information on the different items that can be traded with NPC vendors, the barter prices, and the profits that can be made from selling the items.",
            )}
            key="seo-wrapper"
        />,
                        ...
                        {traders.map((trader) => {
                            return (
                                <ButtonGroupFilterButton
                                    ...
                                    onClick={setSelectedTrader.bind(undefined, trader.normalizedName)}
                                />
                            );
                        })}
                        <ButtonGroupFilterButton
